...
<div class="container">
    ...
    <form action="/Project/studentReg" method="POST" enctype="application/x-www-form-urlencoded">
        <!-- Left Section: Image -->
        <div class="form-section left-section">
            <img src="<%= request.getContextPath() %>/images/admission.png" alt="Admissions">
        </div>
        ...
        <div class="form-section right-section">
            ...
            <input type="radio" id="service" name="Occupation" value="Service">

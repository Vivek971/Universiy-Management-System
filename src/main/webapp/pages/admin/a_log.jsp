...
<body>
    ...
    <div class="navbar">
        ...
        <a href="/Project/pages/aboutus.html">ABOUT US</a>
        <a href="/Project/pages/fdbck.jsp">FEEDBACK</a>
        <a href="/Project/pages/help.jsp">HELP</a>
        <a href="/Project/pages/sitemap.jsp">SITE MAP</a>
        <a href="/Project/pages/stng.jsp">SETTINGS</a>

        <a href="a_log.jsp">ADMIN ZONE</a>
    </div>

    <!-- Main Content -->
    <div class="content"><div class="item">
            <a href="#courses">
                <img src="/Project/images/teach.png" alt="Courses">
            </a>
            <p>Teachers</p>
        </div>
        <div class="item">
            <a href="#exams">
                <img src="/Project/images/stude.jpg" alt="Exams">
            </a>
            <p>Students</p>
        </div>
        <div class="item">
